...
try:
    # talker()
    pub = rospy.Publisher('target', Float32MultiArray, queue_size = 10)
    ...
    # while rospy.is_shutdown():
        ...
        str = "RealSense %s" % rospy.get_time()
        rospy.loginfo(str)
        sendData = Float32MultiArray()
        sendData.data = (findX, findY, minDistance)
